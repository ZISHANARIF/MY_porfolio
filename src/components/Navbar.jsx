  ...
  return (
    <div className='navbar'>
        ...
        <ul className='nav-menu'>
            ...
            <li><AnchorLink className='anchor-link' offset={50} href='#about'><p className='a' onClick={() => ("about")}>Skills</p></AnchorLink></li>
            <li><AnchorLink className='anchor-link' offset={50} href='#services'><p className='s' onClick={() => ("services")}>Projects</p></AnchorLink></li>
